...
@EnableMongoRepositories(
        basePackages = "org.mongodb.spring.multi.repository.cluster2",
        mongoTemplateRef = Cluster2MongoConfig.MONGO_TEMPLATE
)
public class Cluster2MongoConfig extends AbstractMongoMultiClientConfiguration {
    public static final String PREFIX = "cluster2";
    ...
    @Bean(PROPERTIES)
    @ConfigurationProperties(prefix = "spring.data.mongodb.cluster2")
